...
-- REMOVED: idx_users_is_active (column does not exist)
...
-- REMOVED: idx_exercises_is_featured (column does not exist)
...
-- REMOVED: idx_exercises_view_count
-- REMOVED: idx_exercises_like_count
...
-- REMOVED: idx_classes_is_archived
...
-- REMOVED: idx_exercise_attempts_is_submitted
...
-- REMOVED: idx_user_progress_is_mastered
...
-- REMOVED: idx_exercise_likes_exercise_id
-- REMOVED: idx_exercise_likes_user_id
-- REMOVED: idx_exercise_likes_created_at

-- Exercise comments table indexes
-- REMOVED: idx_exercise_comments_exercise_id
-- REMOVED: idx_exercise_comments_user_id
-- REMOVED: idx_exercise_comments_parent_id
-- REMOVED: idx_exercise_comments_created_at
-- REMOVED: idx_exercise_comments_is_deleted
